import { Camera, Entity, EntityRef, RichText, rpc, UIBehavior, value } from "@dreamlab/engine";
...
export default class GameSelectionUI extends UIBehavior {
  ...
  private games: GameOption[] = [
    ...
    { name: "Portals", displayName: "🌀 Portals", path: "world/Portals/Level1/LevelStart" },
    {
      name: "PushableBlocks",
      displayName: "📦 Pushable Blocks",
      path: "world/PushableBlocks/Level1/LevelStart",
    },
    { name: "Sokoban", displayName: "🎯 Sokoban", path: "world/Sokoban/Level1" },
    { name: "Bombs", displayName: "💣 Bombs", path: "world/Bombs/Level1/LevelStart" },
  ];
